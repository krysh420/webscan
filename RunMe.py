...
-> As for dependencies, mainly you will require NodeJS, Python, Docker/Podman installed. The rest will be managed automatically, but make sure to keep Docker/Podman running.
